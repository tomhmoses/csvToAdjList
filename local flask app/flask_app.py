...
from mapper import getSchoolPath, getSchoolMap, getSchoolPlaces, getBlankMap, getTownPath, getTownPlaces, getTownMap, getLabeledTownMap, getClearTownMap
